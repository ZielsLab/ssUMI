...
#convert fastq to fasta (only with medaka 1.6.0 with --qualities in stitch
#$USEARCH -fastq_filter $OUT_DIR/consensus_${OUT_NAME}.fq -fastaout $OUT_DIR/consensus_${OUT_NAME}.fa
